// oldSEAL.cpp : Defines the entry point for the application.
//
...
int callSEAL() {
    ...
    uint64_t number_of_items = 9105;
    uint64_t size_per_item = 512; // in bytes
    uint32_t N = 8192;
...
int main()
{
	...
	cout << "added seal version to header" << endl;
	std::cout << SEAL_VERSION << std::endl;
	cout << "added seal pir to cmakelists" << endl;
    cout << "copied pir code into project" << endl;
    cout << "made new pow_x changes to pir_server" << endl;

    cout << "calling SEAL" << endl;
    callSEAL();
    cout << "Complete" << endl;
	return 0;
}
